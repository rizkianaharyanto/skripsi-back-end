...
<head>
    ...
    <link rel="stylesheet" href="/theme/vendors/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="/theme/vendors/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="/theme/vendors/themify-icons/css/themify-icons.css">
    <link rel="stylesheet" href="/theme/vendors/flag-icon-css/css/flag-icon.min.css">
...
<body>
    @yield('isi')
    <!-- ================== MODAL ================ -->
    <div class="modal fade" id="staticBackdrop" @yield('modal-backdrop') data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" >
    ...
    <!-- <script src="/theme/vendors/chart.js/dist/Chart.bundle.min.js"></script>
    <script src="/theme/assets/js/dashboard.js"></script>
    <script src="/theme/assets/js/widgets.js"></script>
    <script src="/theme/vendors/jqvmap/dist/jquery.vmap.min.js"></script>
